...
function getUserDistrict(user) {
  return user?.district || user?.address?.district || user?.profile?.district || "";
}
...
function getCenterBarangay(center) {
  return center?.barangay || center?.barangayName || center?.address?.barangay || "";
}

function getCenterDistrict(center) {
  return center?.district || center?.address?.district || "";
}
